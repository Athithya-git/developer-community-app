          ...
          <div className="row mt-5">
            ...
            <div className="col-11">
              ...
              <div className="row mt-3 ">
                ...
                <div class="col-3">
                   <button type="button" class="bg-danger text-light"><span class="glyphicon glyphicon-envelope"></span>
                   <span class="badge">Topic = 🔥 Java</span></button> 
                   
                   </div> 
                <div class="col-3">
                   <button type="button" class="bg-danger text-light"><span class="glyphicon glyphicon-envelope"></span>
                   <span class="badge">Relavance = 40</span></button> 
                   </div>   
              ...
              {show === true && (
                <div className="col mt-3">
                  {comments.map((item, index) => (
                   ...
                   <div class="col-2">
                   <button type="button" class="bg-danger text-light"><span class="glyphicon glyphicon-envelope"></span>
                   <span class="badge">Accuracy=40</span></button> 
